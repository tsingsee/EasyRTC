...
public class MobileAEC {
     ...
     *          -1: error
     */
    private static native int nativeInitializeAecmInstance(long aecmHandler,
     ...
     *          -1: error
     */
    private static native int nativeBufferFarend(long aecmHandler,
     ...
     *          -1: error
     */
    private static native int nativeAecmProcess(long aecmHandler,
     ...
     *         -1: error
     */
    private static native int nativeSetConfig(long aecmHandler,
