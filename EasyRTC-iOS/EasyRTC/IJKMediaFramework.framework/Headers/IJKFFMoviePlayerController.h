...
@property (nonatomic, assign) int activeDays;
...
/**
 ...
 @param path path传文件路径，path传nil表示终止录像
 @param seconds 指一个录像文件的最大时长，到了时间没有停止的话,会自动切换文件
 */
- (void)recordFilePath:(const char *)path second:(int)seconds;
