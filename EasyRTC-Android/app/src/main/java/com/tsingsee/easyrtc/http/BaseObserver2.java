...
public abstract class BaseObserver2<E> implements Observer<BaseEntity2<E>> {
    ...
    protected BaseObserver2(Context context, LoadingView dialog, PullToRefreshLayout refreshLayout, boolean isLogin) {
    ...
    @Override
    public void onNext(BaseEntity2<E> value) {
