...
public class MyDPCNCalendar extends DPCalendar {
    ...
    private String[][] buildMonthL(int year, int month) {
        ...
        MyDPCNCalendar.G g = new MyDPCNCalendar.G();
    ...
    private MyDPCNCalendar.L GTL(MyDPCNCalendar.G g) {
        ...
        lunarD = (int) (offset);
        MyDPCNCalendar.L l = new MyDPCNCalendar.L();
        l.y = lunarY;
        l.m = lunarM;
        l.isLeap = false;
